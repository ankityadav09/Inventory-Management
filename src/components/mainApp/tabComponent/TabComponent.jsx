            ...
            <div className="d-flex pt-0 ">
                <div className=" bg-dark ">
                    <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a className="nav-link btn-outline-warning rounded" id="v-pills-report-tab" data-toggle="pill" href="#v-pills-report" role="tab" aria-controls="v-pills-report" aria-selected="false">Report</a>
                    </div>
                </div>
